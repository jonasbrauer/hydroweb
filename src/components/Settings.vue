...
export default {
    ...
    methods: {
        ...
        deleteProperty(property) {
            const path = `${Constants.HOST_URL}/grow/properties/${property.id}`;
            axios.delete(path)
                 .finally(() => {
        ...
        deleteSystem(system) {
            const path = `${Constants.HOST_URL}/grow/systems/${system.id}`;
            axios.delete(path)
                 .finally(() => {
                     this.selectedSystem = null;
        ...
        clearHistoryRecursively(index, sensorIds) {
            const path = `${Constants.HOST_URL}/devices/${this.device.id}/sensors/`;
        ...
        getGrowProperties() {
            const path = `${Constants.HOST_URL}/grow/properties`;
        ...
        getGrowSystems() {
            const path = `${Constants.HOST_URL}/grow/systems`;
